...
class RosBridge:
    ...
    def get_state(self):
        ...
        agribot_position = copy.deepcopy(self.agribot_position)
        agribot_twist = copy.deepcopy(self.agribot_twist)
        state += agribot_position
        state += agribot_twist
        state_dict['pos_x'] = agribot_position[0]
        state_dict['pos_y'] = agribot_position[1]
        state_dict['lin_vel'] = agribot_twist[0]
        state_dict['ang_vel'] = agribot_twist[1]
    ...
    def set_state(self, state_msg):
        ...
        if not self.real_robot :
            ...
            self.set_model_state('agribot', [pos_x, pos_y, 0])
    ...
    def callbackOdometry(self, data):
        ...
        self.agribot_twist = copy.deepcopy([lin_vel, ang_vel])
